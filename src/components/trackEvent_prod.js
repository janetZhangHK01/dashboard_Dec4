...
var myTracker = new trackerClient({
    GA: {
        trackingId: ["UA-70981149-1", "UA-70981149-36", "UA-125354638-13"] // UA-125354638-13 is the profile for hk01data editorial team
    },
    Piwik: {
...
function fireMapPV(url) {
    try {
        myTracker.disableGA({
            ...
            'UA-125354638-13': true, // hk01 data
